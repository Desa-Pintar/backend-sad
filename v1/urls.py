...
router.register(r"sigtoponimi", SigTopominiViewSet)
router.register(r"sigrumahbantuan", SigRumahBantuanViewSet)
router.register(r"sigrumahsehat", SigRumahSehatViewSet)
router.register(r"sigumkm", SigUmkmViewSet)
router.register(r"sigrawanbencana", SigRawanBencanaViewSet)